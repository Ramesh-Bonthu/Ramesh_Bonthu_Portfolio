        ...
        <div className='flex flex-col items-center justify-around h-full md:flex-row relative' id='home' aria-label='Home Section'>
            <div className='my-5'>
                ...
                <div className='flex h-[50px] items-center'>
                    <a href='https://github.com/Ramesh-Bonthu' aria-label='GitHub Profile'><FaGithub className='text-3xl'/></a>
                    <a href='https://www.linkedin.com/in/ramesh-bonthu-207918339/' aria-label='LinkedIn Profile'><FaLinkedinIn className='text-3xl ml-5 hover:fill-blue-400'/></a>
                    <a href='https://www.youtube.com/@RameshBonthu-1021' aria-label='YouTube Channel'><FaYoutube className='text-3xl ml-5 hover:fill-red-600'/></a>
                </div>
            </div>
