            ...
            {loading ? <h1>Loading...</h1> : (
                <div className="max-w-sm w-full bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="bg-indigo-500 px-6 py-4">
                        <h2 className="text-white text-xl font-bold">Leet Code Profile</h2>
                    ...
                    <div className="p-6">
                        <div className="flex items-center mb-4">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-sm text-gray-500">Sloved 150+ problems <span className="font-medium text-indigo-500">{data.highestRating}</span></p>
                            </div>
                        </div>
                        
                        <button className="mt-6 w-full bg-blue-400 text-white py-2 rounded-lg hover:bg-blue-600 transition duration-200"
                            onClick={() => window.open(`https://leetcode.com/u/Ramesh-Bonthu/`, '_blank')} >
                            View Profile
                        </button>
                    </div>
                </div>
